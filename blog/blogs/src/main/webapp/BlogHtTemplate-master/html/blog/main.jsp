        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;"  data-id="1" data-url="/BlogHtTemplate-master/html/teacher/homeworkadd.jsp">作业布置</a></dd>
                        <dd><a href="javascript:;" data-id="2" data-url="/HomeWorkServlet?action=list">作业查看</a></dd>
                        <dd><a href="javascript:;">学员考勤</a></dd>
